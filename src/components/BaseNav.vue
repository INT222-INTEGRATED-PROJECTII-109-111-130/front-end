    ...
    <div class="container mx-auto py-3 px-7 flex justify-between items-center">
      ...
      <router-link to="/team">
        <div class="w-36">
          <div class=" flex items-center hover:text-primary transition duration-200">
            ...
            <p class="font-medium ml-2 text-sm">Team</p>
          </div>
        </div>
      </router-link>
      ...
      <div class="flex items-center space-x-7">
        <router-link to="/basket">
          <span class="material-icons-outlined text-2xl hover:text-primary transition duration-200">local_mall</span>
        </router-link>
        <router-link to="/login">
          <span class="material-icons-outlined text-2xl hover:text-primary transition duration-200">person</span>
        </router-link>
